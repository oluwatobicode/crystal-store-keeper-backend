 ...
 */
const generateEmailLayout = (preheader: string, content: string) => `
...
export const welcomeEmail = async (
  ...
  await resend.emails.send({
    ...
    html: generateEmailLayout(
      "Welcome aboard! Let's get your store set up.",
      content,
    ),
  });
};
...
export const sendOtpEmail = async (
  ...
  await resend.emails.send({
    ...
    html: generateEmailLayout(
      "Your sign-in verification code inside.",
      content,
    ),
  });
};
...
export const inviteUserEmail = async (
  to: string,
  inviteeName: string,
  inviterName: string,
