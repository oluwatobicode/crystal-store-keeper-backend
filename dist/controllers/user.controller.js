...
exports.getUser = exports.getAllUsers = exports.updateUserStatus = exports.updateUser = exports.deleteUser = exports.createUser = void 0;
...
const getAllUsers = async (req, res, next) => {
    try {
        const businessId = req.businessId;
        const users = await User_1.default.find({ businessId }).populate("role");
